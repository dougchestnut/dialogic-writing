 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */;let rt=class extends Qe{};rt.styles=[tt,et,Ze],rt=le([ce("md-filled-button")],rt);
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nt(e){return e&&e._delegate?e._delegate:e}class Dt{constructor(e,t,r){this.name=e,this.instanceFactory=t,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qr="firebase-heartbeat-database",Zr=1,ei="firebase-heartbeat-store";let ti=null;function ri(){return ti||(ti=function(e,t,{blocked:r,upgrade:i,blocking:o,terminated:n}={}){const s=indexedDB.open(e,t),a=ir(s);return i&&s.addEventListener("upgradeneeded",(e=>{i(ir(s.result),e.oldVersion,e.newVersion,ir(s.transaction),e)})),r&&s.addEventListener("blocked",(e=>r(e.oldVersion,e.newVersion,e))),a.then((e=>{n&&e.addEventListener("close",(()=>n())),o&&e.addEventListener("versionchange",(e=>o(e.oldVersion,e.newVersion,e)))})).catch((()=>{})),a}(Qr,Zr,{upgrade:(e,t)=>{if(0===t)try{e.createObjectStore(ei)}catch(e){console.warn(e)}}}).catch((e=>{throw Kr.create("idb-open",{originalErrorMessage:e.message})}))),ti}async function ii(e,t){try{const r=(await ri()).transaction(ei,"readwrite"),i=r.objectStore(ei);await i.put(t,oi(e)),await r.done}catch(e){if(e instanceof St)ur.warn(e.message);else{const t=Kr.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});ur.warn(t.message)}}}function oi(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Lo(e,t){return Li(e,"POST","/v1/accounts:signInWithPassword",Oi(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class No extends Po{constructor(e,t,r,i=null){super("password",r),this._email=e,this._password=t,this._tenantId=i}static _fromEmailAndPassword(e,t){return new No(e,t,"password")}static _fromEmailAndCode(e,t,r=null){return new No(e,t,"emailLink",r)}toJSON(){return{email:this._email,password:this._password,signInMethod:this.signInMethod,tenantId:this._tenantId}}static fromJSON(e){const t="string"==typeof e?JSON.parse(e):e;if((null==t?void 0:t.email)&&(null==t?void 0:t.password)){if("password"===t.signInMethod)return this._fromEmailAndPassword(t.email,t.password);if("emailLink"===t.signInMethod)return this._fromEmailAndCode(t.email,t.password,t.tenantId)}return null}async _getIdTokenResponse(e){switch(this.signInMethod){case"password":return Co(e,{returnSecureToken:!0,email:this._email,password:this._password,clientType:"CLIENT_TYPE_WEB"},"signInWithPassword",Lo);case"emailLink":return async function(e,t){return Li(e,"POST","/v1/accounts:signInWithEmailLink",Oi(e,t))}(e,{email:this._email,oobCode:this._password});default:vi(e,"internal-error")}}async _linkToIdToken(e,t){switch(this.signInMethod){case"password":return Co(e,{idToken:t,returnSecureToken:!0,email:this._email,password:this._password,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",$o);case"emailLink":return async function(e,t){return Li(e,"POST","/v1/accounts:signInWithEmailLink",Oi(e,t))}(e,{idToken:t,email:this._email,oobCode:this._password});default:vi(e,"internal-error")}}_getReauthenticationResolver(e){return this._getIdTokenResponse(e)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Do(e,t){return Li(e,"POST","/v1/accounts:signInWithIdp",Oi(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zo{constructor(){this.providerId=zo.PROVIDER_ID}static credential(e,t){return No._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=Uo.parseLink(t);return _i(r,"argument-error"),No._fromEmailAndCode(e,r.code,r.tenantId)}}zo.PROVIDER_ID="password",zo.EMAIL_PASSWORD_SIGN_IN_METHOD="password",zo.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function qo(e,t){return Li(e,"POST","/v1/accounts:signUp",Oi(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Qo(e){const t=xo(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}function Zo(e,t,r){return qr(e.app)?Promise.reject(bi(e)):async function(e,t){return Xo(xo(e),t)}(Nt(e),zo.credential(t,r)).catch((async t=>{throw"auth/password-does-not-meet-requirements"===t.code&&Qo(e),t}))}function en(e,t,r,i){return Nt(e).onAuthStateChanged(t,r,i)}const tn="__sak";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nn{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach((r=>{this.isEventForConsumer(e,r)&&(t=!0,this.sendToConsumer(e,r),this.saveEventToCache(e))})),this.hasHandledPotentialRedirect||!function(e){switch(e.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Mn(e);default:return!1}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${Rt(a).slice(1)}${c}`}const ss="webStorageSupport";const as=class{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=an,this._completeRedirectFn=Ln,this._overrideRedirectResult=$n}async _openPopup(e,t,r,i){var o;xi(null===(o=this.eventManagers[e._key()])||void 0===o?void 0:o.manager,"_initialize() not called before _openPopup()");return ts(e,await ns(e,t,r,Ii(),i),cn())}async _openRedirect(e,t,r,i){await this._originValidation(e);return function(e){hn().location.href=e}(await ns(e,t,r,Ii(),i)),new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:r}=this.eventManagers[t];return e?Promise.resolve(e):(xi(r,"If manager is not set, promise should be"),r)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch((()=>{delete this.eventManagers[t]})),r}async initAndGetManager(e){const t=await Qn(e),r=new Nn(e);return t.register("authEvent",(t=>{_i(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:r.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(ss,{type:ss},(r=>{var i;const o=null===(i=null==r?void 0:r[0])||void 0===i?void 0:i[ss];void 0!==o&&t(!!o),vi(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Fn(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return go()||lo()||vo()}};var ls="@firebase/auth",cs="1.7.3";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */;let gs=class extends vs{};gs.styles=[ms],gs=le([ce("md-icon")],gs);const bs={apiKey:"AIzaSyD0KLqi6k-H5mstEVvuattvvqa_XooKKIE",authDomain:"dialogic-writing.firebaseapp.com",databaseURL:"https://dialogic-writing-default-rtdb.firebaseio.com",projectId:"dialogic-writing",storageBucket:"dialogic-writing.appspot.com",messagingSenderId:"191541552813",appId:"1:191541552813:web:7b5bcda53dda803d3a4824",measurementId:"G-ZQEX3Y9W9R"};
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */;let Xs=class extends Js{constructor(){super(...arguments),this.fieldTag=nt`md-filled-field`}};Xs.styles=[Ys,Es],Xs=le([ce("md-filled-text-field")],Xs);const Qs=ps(Yr(bs));class Zs extends ne{static properties={user:{type:Object},errorMessage:{type:String},isSignUp:{type:Boolean}};constructor(){super(),this.user=null,this.errorMessage="",this.isSignUp=!1}firstUpdated(){en(Qs,(e=>{this.user=e,this.requestUpdate()}))}async handleSignUp(e){e.preventDefault();const t=this.shadowRoot.querySelector("#sign-up-email").value,r=this.shadowRoot.querySelector("#sign-up-password").value;try{const e=await async function(e,t,r){if(qr(e.app))return Promise.reject(bi(e));const i=xo(e),o=Co(i,{returnSecureToken:!0,email:t,password:r,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",qo),n=await o.catch((t=>{throw"auth/password-does-not-meet-requirements"===t.code&&Qo(e),t})),s=await Ko._fromIdTokenResponse(i,"signIn",n);return await i._updateCurrentUser(s.user),s}(Qs,t,r);this.user=e.user,this.dispatchEvent(new CustomEvent("auth-success",{detail:e}))}catch(e){this.errorMessage=e.message}}async handleSignIn(e){e.preventDefault();const t=this.shadowRoot.querySelector("#sign-in-email").value,r=this.shadowRoot.querySelector("#sign-in-password").value;try{const e=await Zo(Qs,t,r);this.user=e.user,this.dispatchEvent(new CustomEvent("auth-success",{detail:e}))}catch(e){this.errorMessage=e.message}}toggleForm(){this.isSignUp=!this.isSignUp,this.errorMessage=""}render(){return V`
  ...
  `}customElements.define("auth-ui-login",Zs);const ea=ps(Yr(bs));customElements.define("modal-auth-login",class extends ne{static properties={user:{type:Object}};constructor(){super(),this.user=null}connectedCallback(){super.connectedCallback(),en(ea,(e=>{this.user=e,this.requestUpdate()}))}openDialog(){this.shadowRoot.querySelector("#auth-dialog").showModal()}closeDialog(){this.shadowRoot.querySelector("#auth-dialog").close()}async logout(){try{await function(e){return Nt(e).signOut()}(ea),console.log("User signed out successfully")}catch(e){console.error("Error signing out:",e)}}render(){return V`
      ${this.user?V`
