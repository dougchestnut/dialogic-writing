 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Un(e,t){$n(e.emulator,"Emulator should always be set here");const{url:r}=e.emulator;return t?`${r}${t.startsWith("/")?t.slice(1):t}`:r}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uo=new Map;function po(e){$n(e instanceof Function,"Expected a class definition");let t=uo.get(e);return t?($n(t instanceof e,"Instance stored in cache mismatched with class"),t):(t=new e,uo.set(e,t),t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */()}function Fo(e){const t=e.indexOf(":");return t<0?"":e.substr(0,t+1)}function Vo(e){if(!e)return null;const t=Number(e);return isNaN(t)?null:t}class Bo{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return Pn("not implemented")}_getIdTokenResponse(e){return Pn("not implemented")}_linkToIdToken(e,t){return Pn("not implemented")}_getReauthenticationResolver(e){return Pn("not implemented")}}async function Ho(e,t){return Bn(e,"POST","/v1/accounts:signUp",t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function cs(e){const t=$o(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}function ds(e,t,r){return rn(e.app)?Promise.reject(kn(e)):async function(e,t){return ls($o(e),t)}(Wr(e),Yo.credential(t,r)).catch((async t=>{throw"auth/password-does-not-meet-requirements"===t.code&&cs(e),t}))}function hs(e,t,r,i){return Wr(e).onAuthStateChanged(t,r,i)}const us="__sak";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class $s extends Bo{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return Ko(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Ko(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Ko(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function Ls(e){return ls(e.auth,new $s(e),e.bypassAuthState)}function Ns(e){const{auth:t,user:r}=e;return On(r,t,"internal-error"),
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
async function(e,t,r=!1){const{auth:i}=e;if(rn(i.app))return Promise.reject(kn(i));const n="reauthenticate";try{const o=await io(e,as(i,n,t,e),r);On(o.idToken,i,"internal-error");const s=to(o.idToken);On(s,i,"internal-error");const{sub:a}=s;return On(e.uid===a,i,"user-mismatch"),ns._forOperation(e,n,o)}catch(e){throw"auth/user-not-found"===(null==e?void 0:e.code)&&An(i,"user-mismatch"),e}}(r,new $s(e),e.bypassAuthState)}async function Ds(e){const{auth:t,user:r}=e;return On(r,t,"internal-error"),async function(e,t,r=!1){const i=await io(e,t._linkToIdToken(e.auth,await e.getIdToken()),r);return ns._forOperation(e,"link",i)}(r,new $s(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${jr(a).slice(1)}${c}`}const ma="webStorageSupport";const ga=class{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=gs,this._completeRedirectFn=Hs,this._overrideRedirectResult=Bs}async _openPopup(e,t,r,i){var n;$n(null===(n=this.eventManagers[e._key()])||void 0===n?void 0:n.manager,"_initialize() not called before _openPopup()");return ha(e,await va(e,t,r,Ln(),i),ys())}async _openRedirect(e,t,r,i){await this._originValidation(e);return function(e){ws().location.href=e}(await va(e,t,r,Ln(),i)),new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:r}=this.eventManagers[t];return e?Promise.resolve(e):($n(r,"If manager is not set, promise should be"),r)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch((()=>{delete this.eventManagers[t]})),r}async initAndGetManager(e){const t=await la(e),r=new Ws(e);return t.register("authEvent",(t=>{On(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:r.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(ma,{type:ma},(r=>{var i;const n=null===(i=null==r?void 0:r[0])||void 0===i?void 0:i[ma];void 0!==n&&t(!!n),An(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Ys(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return To()||_o()||Ao()}};var ba="@firebase/auth",ya="1.7.3";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 */;let al=class extends ol{constructor(){super(...arguments),this.fieldTag=vr`md-filled-field`}};al.styles=[sl,La],al=mt([gt("md-filled-text-field")],al);const ll=Ea(an(Ta));class cl extends ne{static properties={user:{type:Object},errorMessage:{type:String},isSignUp:{type:Boolean}};constructor(){super(),this.user=null,this.errorMessage="",this.isSignUp=!1}firstUpdated(){hs(ll,(e=>{this.user=e,this.requestUpdate()}))}async handleSignUp(e){e.preventDefault();const t=this.shadowRoot.querySelector("#sign-up-email").value,r=this.shadowRoot.querySelector("#sign-up-password").value;try{const e=await async function(e,t,r){if(rn(e.app))return Promise.reject(kn(e));const i=$o(e),n=zo(i,{returnSecureToken:!0,email:t,password:r,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",is),o=await n.catch((t=>{throw"auth/password-does-not-meet-requirements"===t.code&&cs(e),t})),s=await ns._fromIdTokenResponse(i,"signIn",o);return await i._updateCurrentUser(s.user),s}(ll,t,r);this.user=e.user,this.dispatchEvent(new CustomEvent("auth-success",{detail:e}))}catch(e){this.errorMessage=e.message}}async handleSignIn(e){e.preventDefault();const t=this.shadowRoot.querySelector("#sign-in-email").value,r=this.shadowRoot.querySelector("#sign-in-password").value;try{const e=await ds(ll,t,r);this.user=e.user,this.dispatchEvent(new CustomEvent("auth-success",{detail:e}))}catch(e){this.errorMessage=e.message}}toggleForm(){this.isSignUp=!this.isSignUp,this.errorMessage=""}render(){return M`
  ...
  `;render(){return M`
    ...
    `}}customElements.define("home-page",ul);class pl extends ne{static styles=o`
    :host {
      display: block;
      padding: 16px;
    }
  `;render(){return M`
    ...
    `}}customElements.define("intro-page",pl);class fl extends ne{static styles=o`
    :host {
      display: block;
      padding: 16px;
  ...
  `;firstUpdated(){new ct(this.shadowRoot.querySelector("main")).setRoutes([{path:"/",component:"home-page"},{path:"/intro",component:"intro-page"}])}render(){return M`
      ...
      <main></main>
    `}}customElements.define("my-app",fl);
